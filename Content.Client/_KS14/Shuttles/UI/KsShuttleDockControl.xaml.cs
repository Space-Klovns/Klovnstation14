...
/// <summary>
///     The fork counterpart of the upstream <see cref="ShuttleDockControl"/>, copied
///         rather than subclassed because that control is sealed, and kept a copy so
///         the shared control stays pristine master for vanilla consoles. Docking
///         behaviour is identical; only the instrument presentation differs.
/// </summary>
...
public sealed partial class KsShuttleDockControl : BaseShuttleControl
{
    ...
    private KsInstrumentPalette KsPalette => KsHud.GetScreen("dock");
    ...
    /// <summary>Store buttons for every other dock.</summary>
    ...
    /// <summary>Rate-limiting for docking changes.</summary>
    ...
    public KsShuttleDockControl() : base(2f, 32f, 8f)
    {
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        // Fork change: the backing and the dead screen wear the instrument palette.
        ...
        handle.DrawRect(PixelSizeBox, KsPalette.Background);
        ...
        foreach (var grid in _grids)
        {
            ...
            foreach (var dock in gridDocks)
            {
                ...
                // Can draw when on the same grid or in range: docked stuff far away
                // would just overlap our buttons.
    ...
    public void BuildDocks(EntityUid? shuttle)
    {
        ...
        foreach (var (otherShuttle, docks) in DockState.Docks)
        {
            ...
            foreach (var dock in docks)
            {
                ...
                // Fork change: the floating dock chip wears the instrument palette.
                var panel = new PanelContainer()
                {
                    ...
                    {
                        BackgroundColor = KsPalette.Background.WithAlpha(0.85f),
                        BorderColor = KsPalette.AccentDim,
                ...
                container.AddChild(new Label()
                {
                    ...
                    FontColorOverride = KsPalette.Text,
                });
