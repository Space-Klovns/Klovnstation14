...
public sealed partial class FancyResearchConsoleMenu : FancyWindow
{
    ...
    {
        // must match the function BaseWindow.GetDragModeFor reacts to (UIClick), not Use.
        // Both fire off the same MouseLeft press as separate bubbled events, so using Use here
        // raced against the window's own drag-start check and _draggin wasn't set in time.
