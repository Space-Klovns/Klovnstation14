...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> AmbienceVolume =
        CVarDef.Create("ambience.volume_ks14" /* KS14: add `_ks14` because we apply restrictions on this value, so dont destroy existing values */, 1.5f, CVar.ARCHIVE | CVar.CLIENTONLY);

    /// <summary>
    ///     Ambience music volume.
    /// </summary>
    public static readonly CVarDef<float> AmbientMusicVolume =
        CVarDef.Create("ambience.music_volume_ks14" /* KS14: add `_ks14` because we apply restrictions on this value, so dont destroy existing values */, 1.5f, CVar.ARCHIVE | CVar.CLIENTONLY);
