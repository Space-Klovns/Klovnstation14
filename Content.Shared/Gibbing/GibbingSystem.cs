...
public sealed partial class GibbingSystem : EntitySystem
{
    ...
    public HashSet<EntityUid> Gib(EntityUid ent, bool dropGiblets = true, EntityUid? user = null, bool doGibVisFx = true /* KS14 Addition */)
    {
        ...
        if (doGibVisFx)
            PredictedSpawnAtPosition(GibEffectProtoId, Transform(ent).Coordinates);
    ...
    private const float GibletLaunchImpulse = 60; // KS14: Increased
    private const float GibletLaunchImpulseVariance = 10; // KS14: Increased
