...
namespace Content.Shared._KS14.Construction;
...
public sealed partial class UpgradeKitComponent : Component
{
    ...
    /// </summary>
    [DataField] // Fixed: Removed (required: true) to prevent crashes on empty lists
    public EntityWhitelist Whitelist = new();

    /// <summary>
    /// A blacklist that entities cannot match to be upgraded.
    /// </summary>
    [DataField] // Fixed: Removed (required: true)
