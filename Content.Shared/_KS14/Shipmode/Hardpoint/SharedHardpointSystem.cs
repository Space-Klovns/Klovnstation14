...
using Content.Shared._KS14.ShipMode.ShipGun;
...
public abstract partial class SharedHardpointSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<ShipGunComponent, AnchorStateChangedEvent>(OnAnchorChange);
        SubscribeLocalEvent<ShipGunComponent, MapInitEvent>(OnMapLoad);
        SubscribeLocalEvent<HardpointComponent, AnchorStateChangedEvent>(OnHardpointAnchor);
        SubscribeLocalEvent<ShipGunComponent, ComponentRemove>(OnShipgunRemove);
        // TODO: ACCOUNT FOR REMOVING IT IN ADMIN MODE
        _sawmill = IoCManager.Resolve<ILogManager>().GetSawmill("ks14.hardpoints");
    }

    public void OnMapLoad(EntityUid uid, ShipGunComponent comp, ref MapInitEvent args)
    {
    ...
    public void OnAnchorChange(EntityUid uid, ShipGunComponent component, ref AnchorStateChangedEvent args)
    {
    ...
    public void Deanchor(EntityUid target, EntityUid anchor, EntityUid grid, ShipGunComponent component)
    {
    ...
    public void OnShipgunRemove(EntityUid uid, ShipGunComponent component, ComponentRemove args)
    {
        if (component.anchoredTo is null)
        {
            return;
    ...
    /// <param name="component"></param>
    /// <returns></returns>
    public bool TryAnchorToHardpoint(EntityUid uid, ShipGunComponent component)
    {
    ...
    public void AnchorEntityToHardpoint(EntityUid target, EntityUid anchor, ShipGunComponent targetComp, HardpointComponent hardpoint, EntityUid grid)
    {
