...
public abstract partial class SharedSolutionContainerSystem
{
    protected void InitializeRelays()
    {
        ...
        SubscribeLocalEvent<FitsInDispenserComponent, SolutionChangedEvent>(OnFitsInDispenserSolutionChanged); // Starlight-edit: relay to parent
    }

    #region Relay Event Handlers

    // Starlight-start: relay solution changes from beakers to parent dispenser
    // TODO LCDC: this used SolutionContainerChangedEvent, doubt this is the same
