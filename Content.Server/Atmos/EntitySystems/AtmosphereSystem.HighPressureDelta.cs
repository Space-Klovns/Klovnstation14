...
namespace Content.Server.Atmos.EntitySystems
{
    ...
    {
        [Dependency] private ThrowingSystem _throwingSystem = default!; // KS14
            ...
            PhysicsComponent? physics = null)
        {
                ...
                || (physics.BodyType == BodyType.Static && (maxForce >= (component.MoveResist * MovedByPressureComponent.MoveForceForcePushRatio))))
            {
                ...
                if (maxForce > MovedByPressureComponent.ThrowForce)
                {
                    ...
                    {
                        _throwingSystem.TryThrow(uid, dirVec.Normalized() * MathF.Min(moveForce, SpaceWindMaxVelocity), moveForce,
